...
final class MsgCollector
{
     ...
     *                        MsgCollector::ERROR, MsgCollector::WARNING, MsgCollector::NOTICE
     *                        or MsgCollector::DEPRECATED.
     *                        Defaults to MsgCollector::NOTICE.
     *
     * @return void
     *
    ...
    public function add($message, $type=self::NOTICE)
    {
        ...
        if ($type !== self::ERROR
            ...
            throw new InvalidArgumentException('The message $type should be one of the predefined MsgCollector constants. Received: '.$type);
        }
     ...
     *                      Should be one of the following constants: MsgCollector::ORDERBY_SEVERITY,
     *                      MsgCollector::ORDERBY_RECEIVED.
     *                      Defaults to MsgCollector::ORDERBY_SEVERITY.
     *
     * @return void
     *
