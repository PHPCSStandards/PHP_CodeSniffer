...
final class ExitKeywordTest extends AbstractTokenizerTestCase
{
    ...
    public static function dataNotExitKeyword()
    {
        return [
            ...
            'exit not keyword: goto label 1 (illegal)'                => [
                'testMarker'  => '/* testNotExitGotoLabel1 */',
                'testContent' => 'exit',
            ],
            'exit not keyword: goto label 2 (illegal)'                => [
                'testMarker'  => '/* testNotExitGotoLabel2 */',
                'testContent' => 'exit',
                'expected'    => 'T_GOTO_LABEL',
            ],
            'die not keyword: goto label 1 (illegal)'                 => [
                'testMarker'  => '/* testNotDieGotoLabel1 */',
                'testContent' => 'die',
            ],
            'die not keyword: goto label 2 (illegal)'                 => [
                'testMarker'  => '/* testNotDieGotoLabel2 */',
                'testContent' => 'die',
                'expected'    => 'T_GOTO_LABEL',
            ],
        ];
