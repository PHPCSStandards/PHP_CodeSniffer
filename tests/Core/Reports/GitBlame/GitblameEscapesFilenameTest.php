...
final class GitblameEscapesFilenameTest extends TestCase
{
     ...
     * @var string
     */
    private const DO_NOT_CREATE_FILE = 'newfile.txt';
    ...
    private function generateReport($args)
    {
        ...
        $reflMethod->invoke($runner);

        $result = ($runner->reporter->totalErrors + $runner->reporter->totalWarnings);
     ...
     * @return void
     */
    public function verifyFileDoesNotExist($fileName, $errorMessage): void
    {
